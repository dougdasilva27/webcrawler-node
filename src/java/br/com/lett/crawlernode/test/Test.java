...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.telhanorte.com.br/ar-condicionado-de-ar-quente-e-frio-split-12000-btus-philco-90000020/p", market);
