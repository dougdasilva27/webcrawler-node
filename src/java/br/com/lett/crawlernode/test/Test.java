...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.lebes.com.br/ar-condicionado-split-consul-9000-btus-quente-frio-cbw09-cbx09-branco-547251-52/p", market);
