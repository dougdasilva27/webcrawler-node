...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.copafer.com.br/furadeira-impacto-11a0-gsb-550-kit-14-brocas-06011a02d1-000-bosch/p3476550", market);
