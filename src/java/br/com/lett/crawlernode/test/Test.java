...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.camicado.com.br/cafeteira-eletrica-inissia-preta-127v-nespresso/p/000000000000027106", market);
