...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.shopfato.com.br/ar-condicionado-split-hi-wall-lg-smile-24-000-btus-frio-220v-2002179/p", market);
