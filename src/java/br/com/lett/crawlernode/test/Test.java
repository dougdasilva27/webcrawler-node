...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.supermuffato.com.br/cervejeira-vertical-frost-free-120-litros-127v-inox-preto-gelopar-31319/p", market);
