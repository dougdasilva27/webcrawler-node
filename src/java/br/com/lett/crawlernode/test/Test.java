...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			Session session = SessionFactory.createSession("http://www.angeloni.com.br/eletro/p/cafeteira-eletrica-fischer-le-cheff-25-xicaras-jarra-de-vidro-13469-3750354", market);
