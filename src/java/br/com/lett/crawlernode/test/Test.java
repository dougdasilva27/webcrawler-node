...
public class Test {
	...
	public static void main(String args[]) {
		...
		if (market != null) {
			...
			CrawlerSession session = SessionFactory.createSession("http://www.schumann.com.br/cafeteira-digital-oster-flavo-programavel-36-xicaras-vermelho-220v/p", market);
