...
public class EnvironmentVariables {
   ...
   public static final String HIKARI_CP_MAX_POOL_SIZE = "HIKARI_CP_MAX_POOL_SIZE";
   public static final String HIKARI_CP_MIN_IDLE = "HIKARI_CP_MIN_IDLE";
   ...
   public static final String KINESIS_STREAM_DISCOVERY = "KINESIS_STREAM_DISCOVERY";
