...
public class ProcessedModelSanitizer {
	 ...
	 */
//	public static void prepareToPersistt(ProcessedModel processedModel) {
//		
...
//		Marketplace marketplace = processedModel.getMarketplace();
...
//		Boolean 	void_product = processedModel.isVoid();
