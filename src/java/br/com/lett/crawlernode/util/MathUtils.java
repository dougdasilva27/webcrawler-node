...
public class MathUtils {
  ...
  /**
   * Parse all numbers from a string and returns a list containing all the found numbers.
   * 
   * @param s
   * @return
   */
  ...
  /**
   * Takes a String representing a non formated Float, and inserts a '.'. This method is mostly used
   * to parse sku prices, when they are in a non formated form in Json. We always use two decimal
   * places to format the Float, as we are representing prices.
   * 
   * e.g: 11999 -> 119.99
   * 
   * @param input
  ...
  /**
   * Given a list of ordered disjoint intervals, select the interval where the number n fits, using a
