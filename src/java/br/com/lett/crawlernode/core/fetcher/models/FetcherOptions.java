...
public class FetcherOptions {
   ...
   public static final String FETCHER_PARAMETER_RETRIEVE_BYTE_ARRAY = "retrieve_byte_array";

   private boolean mustUseMovingAverage;
   private boolean retrieveStatistics;
   private boolean retrieveByteArray = false;
   ...
   public JSONObject toJson() {
      ...
      fetcherParameters.put(FETCHER_PARAMETER_RETRIEVE_BYTE_ARRAY, retrieveByteArray);
   ...
   public boolean isRetrieveByteArray() {
      return retrieveByteArray;
   }
   ...
   public static class FetcherOptionsBuilder {
      ...
      public FetcherOptionsBuilder mustRetrieveByteArray(boolean must) {
         this.retrieveByteArray = must;
         return this;
      }
      ...
      public FetcherOptions build() {
         ...
         options.setRetrieveByteArray(this.retrieveByteArray);
