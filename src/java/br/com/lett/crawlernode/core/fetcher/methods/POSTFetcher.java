...
public class POSTFetcher {
  ...
  public static String fetchPagePOST(Session session, String url, String urlParameters, List<Cookie> cookies, int attempt) {
    ...
    try {
      ...
      DataFetcher.sendRequestInfoLog(url, DataFetcher.POST_REQUEST, randProxy, randUserAgent, session, closeableHttpResponse, responseLength,
          requestHash);
  ...
  public static JSONObject requestWithFetcher(Session session, JSONObject payload, Integer timeout) throws Exception {
    ...
    Integer defaultTimeout = /* timeout == null ? DataFetcher.DEFAULT_CONNECTION_REQUEST_TIMEOUT * 15 : timeout */1;
