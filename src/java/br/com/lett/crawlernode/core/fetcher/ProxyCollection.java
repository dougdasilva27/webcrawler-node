...
public class ProxyCollection {
	...
	public ProxyCollection(Markets markets) {
		...
		proxyMaxAttempts.put(LUMINATI_RESIDENTIAL_BR, MAX_ATTEMPTS_LUMINATI_RESIDENTIAL_MX);
		proxyMaxAttempts.put(LUMINATI_RESIDENTIAL_BR, MAX_ATTEMPTS_LUMINATI_RESIDENTIAL_AR);
	...
	private void setLuminatiResidentialBrProxy() {
		...
		luminatiBr.add(new LettProxy(LUMINATI_RESIDENTIAL_BR, "zproxy.luminati.io", 22225, "brazil", "lum-customer-lettinsights-zone-residential_br-country-br", "bKhgwEQijyG92jR9kvBPw"));
	...
	private void setLuminatiResidentialMxProxy() {
		...
		luminatiResidentialMx.add(new LettProxy(LUMINATI_RESIDENTIAL_MX, "zproxy.luminati.io", 22225, "mexico", "lum-customer-lettinsights-zone-residential_br-country-mx", "bKhgwEQijyG92jR9kvBPw"));
	...
	private void setLuminatiResidentialArProxy() {
		...
		luminatiResidentialAr.add(new LettProxy(LUMINATI_RESIDENTIAL_AR, "zproxy.luminati.io", 22225, "argentina", "lum-customer-lettinsights-zone-residential_br-country-ar", "bKhgwEQijyG92jR9kvBPw"));
