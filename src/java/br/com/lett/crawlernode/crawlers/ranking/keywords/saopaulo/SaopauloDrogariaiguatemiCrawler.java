...
public class SaopauloDrogariaiguatemiCrawler extends CrawlerRankingKeywords {
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://drogariaiguatemi.com.br/catalogsearch/result/?q=" + keyword + "&p=" + this.currentPage;
      ...
      // Se existir uma mensagem de "Não foram encontrados resultados exatos para a busca", devemos
      // desconsiderar a lista de produtos retornada.
