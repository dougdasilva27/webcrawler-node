...
public class NatalNordestaoCrawler extends CrawlerRankingKeywords {
   ...
   private void changeUrl(){
      ...
      apiUrl = "https://api.cliqueretire.nordestao.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/2/termo/" + this.keywordEncoded + "?page=" + this.currentPage;
   }
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.cliqueretire.nordestao.com.br/produtos/buscas?q=" + this.keywordEncoded + "?page=" + this.currentPage;
      changeUrl();
      ...
      if (produtosArray.length() >= 1) {
         ...
         for (Object e : produtosArray) {
            ...
            String urlHost = "https://www.cliqueretire.nordestao.com.br/produtos/detalhe/" + internalId;
