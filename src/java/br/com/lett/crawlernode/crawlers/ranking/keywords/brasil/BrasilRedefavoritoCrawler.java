...
public class BrasilRedefavoritoCrawler extends CrawlerRankingKeywords {
   ...
   public String getToken() {
      ...
      String url = "https://api.favoritosupermercados.com.br/v1/auth/loja/login";

      Map<String, String> headers = new HashMap<>();
      headers.put("content-type", "application/json");
      headers.put("origin", "https://www.dalbendelivery.com.br");

      JSONObject payload = new JSONObject()
            .put("domain", "dalbendelivery.com.br")
            .put("username", "loja")
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.favoritosupermercados.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" + this.keywordEncoded;
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.favoritosupermercados.com.br/produtos/buscas?q=" + this.keywordEncoded + "&page=" + this.currentPage;
      ...
      if (produtosArray.length() >= 1) {
         ...
         for (Object e : produtosArray) {
            ...
            String urlHost = "www.favoritosupermercados.com.br/produtos/detalhe/" + internalId;
