...
public class BrasilMateusmaisCrawler extends CrawlerRankingKeywords {
   ...
   private JSONObject getProductList() {
      ...
      String payload = "{\"params\":\"page=" + (this.currentPage - 1) + "&hitsPerPage=25&clickAnalytics=true&query=" + this.keywordEncoded + "&facetFilters=%5B%5B%22market_id%3A" + marketCode + "%22%5D%2C%5B%5D%2C%5B%5D%5D&numericFilters=%5B%5D\"}";
