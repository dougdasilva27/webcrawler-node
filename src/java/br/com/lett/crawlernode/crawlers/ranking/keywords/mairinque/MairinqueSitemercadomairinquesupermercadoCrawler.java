package br.com.lett.crawlernode.crawlers.ranking.keywords.mairinque;
 ...
 */
public class MairinqueSitemercadomairinquesupermercadoCrawler extends BrasilSitemercadoCrawler {

   public MairinqueSitemercadomairinquesupermercadoCrawler(Session session) {
      super(session);
   }
