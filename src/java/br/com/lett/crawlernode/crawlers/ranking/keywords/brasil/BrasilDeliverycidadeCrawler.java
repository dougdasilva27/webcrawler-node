...
public class BrasilDeliverycidadeCrawler extends CrawlerRankingKeywords {
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.deliverycidade.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" + this.keywordEncoded;
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.deliverycidade.com.br/produtos/buscas?q=" + this.keywordEncoded + "&page=" + this.currentPage;
      ...
      if (produtosArray.length() >= 1) {
         ...
         for (Object e : produtosArray) {
            ...
            String urlHost = "www.deliverycidade.com.br/produtos/detalhe/" + internalId;
