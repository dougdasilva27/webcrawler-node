...
public class ChileJumbolareinaCrawler extends CrawlerRankingKeywords {
  ...
  @Override
	protected void processBeforeFetch() {
	    ...
	    BasicClientCookie cookie = new BasicClientCookie("VTEXSC", "sc=" + ChileJumboCrawler.JUMBO_LAREINA_ID);
