...
public class RomaniaEmagCrawler extends CrawlerRankingKeywords {
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.emag.ro/supermarket/search/" + this.keywordWithoutAccents + "/p" + this.currentPage;
      ...
      if (!products.isEmpty()) {
         ...
         for (Element e : products) {
            String internalId = CrawlerUtils.scrapStringSimpleInfoByAttribute(e, ".card-toolbox .add-to-favorites.btn.btn-lg", "data-productid");
