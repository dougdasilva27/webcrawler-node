...
public class BrasilMercadolivretelhanorteCrawler extends MercadolivreCrawler {
   ...
   private final String URL = "https://lista.mercadolivre.com.br/" + this.keywordWithoutAccents.replace(" ", "-") + "_Loja_telhanorte#D[A:"
         + this.keywordWithoutAccents.replace(" ", "+") + ",telhanorte]";
