...
public class PeruGrouponCrawler extends CrawlerRankingKeywords {
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.groupon.com.pe/lima/search?q=" + this.keywordEncoded + "&offset=" + this.arrayProducts.size();

      this.log("Link onde são feitos os crawlers: " + url);
      this.currentDoc = fetchDocument(url);
      Elements products = this.currentDoc.select("#deals-div div.row > div figure");
      if (!products.isEmpty()) {
