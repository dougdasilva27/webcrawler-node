...
public class MexicoChedrauiCrawler extends CrawlerRankingKeywords {
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "https://www.chedraui.com.mx/chedrauistorefront/chedraui/es/search/?text="
				+ this.keywordEncoded;

		if (this.currentPage > 1 && isCategory) {
			url = this.urlCategory + "?q=%3Arelevance&page=" + (this.currentPage - 1) + "&pageSize=24";
		} else if (this.currentPage > 1) {
			url = "https://www.chedraui.com.mx/chedrauistorefront/chedraui/es/search?q="
					+ this.keywordEncoded + "%3Arelevance&page=" + (this.currentPage - 1) + "&pageSize=24";
		}
