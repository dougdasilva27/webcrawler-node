...
public class MexicoRappichedrauiCrawler extends CrawlerRankingKeywords {
  ...
  private JSONObject fetchProductsFromAPI(String storeType, String store) {
    ...
    String payload = "{\"query\":\"" + this.location + "\",\"stores\":[\"" + store + "\"],\"store_type\":\"chedraui\",\"page\":" + this.currentPage
