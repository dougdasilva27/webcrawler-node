...
public class BrasilDalbendeliveryCrawler extends CrawlerRankingKeywords {
   ...
   public String getToken() {
      ...
      String url = "https://api.dalbendelivery.com.br/v1/auth/loja/login";
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.dalbendelivery.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" + this.keywordEncoded;
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.dalbendelivery.com.br/produtos/buscas?q=" + this.keywordEncoded + "&page=" + this.currentPage;
      ...
      if (produtosArray.length() >= 1) {
         ...
         for (Object e : produtosArray) {
            ...
            String urlHost = "www.dalbendelivery.com.br/produtos/detalhe/" + internalId;
