...
public class ChileCornershoplidernunoaCrawler extends CrawlerRankingKeywords {
  ...
  public void extractProductsFromCurrentPage() {
    ...
    String url = "https://cornershopapp.com/api/v1/branches/"
        + br.com.lett.crawlernode.crawlers.corecontent.chile.ChileCornershoplidernunoaCrawler.STORE_ID + "/search?query=" + this.keywordEncoded;
