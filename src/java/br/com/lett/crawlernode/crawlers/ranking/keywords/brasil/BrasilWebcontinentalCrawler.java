...
public class BrasilWebcontinentalCrawler extends CrawlerRankingKeywords {
	...
	protected void extractProductsFromCurrentPage() {
		...
		if(session instanceof RankingSession && ((RankingSession)session).mustTakeAScreenshot() && this.currentPage <= 2) {
			...
			if(this.categoryUrl == null) {
				printUrl = "https://www.webcontinental.com.br/searchresults?Ntt=ar"+ keyword +"&Nty=1&No=0&Nrpp=12&Rdm=856&searchType=simple&type=search&page=" + this.currentPage;
			} else {
	...
	private String crawlProductUrl(String internalPid){
		return internalPid != null ? "https://www.webcontinental.com.br/product/" + internalPid : null;
	}
}
