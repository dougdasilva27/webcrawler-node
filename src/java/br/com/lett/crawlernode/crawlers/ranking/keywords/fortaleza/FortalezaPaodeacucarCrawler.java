...
public class FortalezaPaodeacucarCrawler extends CrawlerRankingKeywords {
  ...
  protected void processBeforeFetch() {
    BasicClientCookie cookie = new BasicClientCookie("ep.selected_store", GPACrawler.FORTALEZA_STORE_ID);
  ...
  private JSONObject crawlSearchApi() {
    String url = "https://paodeacucar.resultspage.com/search?af=&cnt=36&ep.selected_store=" + GPACrawler.RIO_DE_JANEIRO_STORE_ID
        + "&isort=&lot=json&p=Q&" + "ref=www.paodeacucar.com.br&srt=" + this.arrayProducts.size() + "&ts=json-full"
