...
public class FlorianopolisHippoCrawler extends CrawlerRankingKeywords {
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.hippo.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" + this.keywordEncoded;
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.hippo.com.br/produtos/buscas?q=" + this.keywordEncoded + "&page=" + this.currentPage;
