...
public class ArgentinaGarbarinoCrawler extends CrawlerRankingKeywords {
  ...
  private String crawlProductUrl(Element e) {
    ...
    Element urlElement = e.selectFirst("a.itemBox--info[href]");
    
    if (!urlElement.text().contains("www.garbarino.com")) {
      productUrl = ("https://www.garbarino.com/" + urlElement.attr("href")).replace(".com//", ".com/");
    }
