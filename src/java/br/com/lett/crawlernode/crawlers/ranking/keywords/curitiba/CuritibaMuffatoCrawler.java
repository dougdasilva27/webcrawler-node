...
public class CuritibaMuffatoCrawler extends CrawlerRankingKeywords{
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "http://buscadelivery.supermuffato.com.br/busca?q="+ this.keywordEncoded +"&page="+ this.currentPage;
	...
	protected void setTotalProducts() {
		...
		try {
			if(totalElement != null) this.totalProducts = Integer.parseInt(totalElement.text().replaceAll("[^0-9]", "").trim());
		} catch(Exception e) {
