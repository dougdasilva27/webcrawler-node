 ...
 *
 */
class BrasilCarvalhosupershopCrawler(session: Session) : CrawlerRankingKeywords(session) {
   ...
   private fun fetchData(apiToken: String, currentPage: Int): JSONObject {
      val url = "https://api.carvalhosupershop.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" +
         keywordEncoded +
         "?page=${currentPage}"
   ...
   override fun extractProductsFromCurrentPage() {
      ...
      for (e in products) {
         ...
         val urlProduct = "http://www.carvalhosupershop.com.br/produtos/detalhe/$internalId/${link}"
