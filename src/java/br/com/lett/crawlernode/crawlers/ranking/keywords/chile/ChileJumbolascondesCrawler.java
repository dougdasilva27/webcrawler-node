...
public class ChileJumbolascondesCrawler extends CrawlerRankingKeywords {
  ...
  @Override
	protected void processBeforeFetch() {
	    ...
	    BasicClientCookie cookie = new BasicClientCookie("VTEXSC", "sc=" + ChileJumboCrawler.JUMBO_LASCONDES_ID);
