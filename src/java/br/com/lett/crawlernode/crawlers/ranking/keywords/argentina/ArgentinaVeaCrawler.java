...
public class ArgentinaVeaCrawler extends CrawlerRankingKeywords{
	...
	protected void processBeforeFetch() {
		if(this.cookies.size() < 1){
			Map<String,String> cookiesMap = fetchCookies("https://www.veadigital.com.ar/Login/PreHome.aspx");
	...
	private String crawlProductUrl(JSONObject product){
		...
		if(product.has("DescripcionArticulo")){
			...
			productUrl = "https://www.veadigital.com.ar/Comprar/Home.aspx?#_atCategory=false&_atGrilla=true&_query=" + name;
		}
