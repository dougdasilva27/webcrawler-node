...
public class SaopauloSubmarinoCrawler extends CrawlerRankingKeywords {
  ...
  protected void extractProductsFromCurrentPage() {
    ...
    String url = "https://www.submarino.com.br/busca/" + this.keywordEncoded + "?limite=24&offset=" + this.arrayProducts.size();
  ...
  protected void extractProductsFromAPI() {
    ...
    String urlAPi = "https://mystique-v1-submarino.b2w.io/mystique/search?content=" + keyword + "&offset=" + +this.arrayProducts.size()
