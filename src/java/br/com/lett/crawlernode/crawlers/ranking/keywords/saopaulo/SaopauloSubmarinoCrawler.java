...
public class SaopauloSubmarinoCrawler extends CrawlerRankingKeywords {
	...
	private String crawlProductUrl(Element e) {
		...
		if (urlElement != null) {
			...
			if (!urlProduct.startsWith("http://www.submarino.com.br")) {
				urlProduct = "http://www.submarino.com.br" + urlProduct;
			}
		}
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "http://www.submarino.com.br/busca/?conteudo=" + keyword + "&limite=24&offset="
	...
	protected boolean hasNextPage() {
		Element page = this.currentDoc.select(".card.card-pagination .pagination-icon:not(.pagination-icon-previous)")
				.first();
		;
