...
public class BrasilPetshopwebCrawler extends CrawlerRankingKeywords {

  public BrasilPetshopwebCrawler(Session session) {
    super(session);
  }
  ...
  public void extractProductsFromCurrentPage() {
    ...
    String url = "https://www.petshopweb.com.br/loja/busca.php?loja=665912&palavra_busca=" + this.keywordEncoded + "&pg=" + this.currentPage;
