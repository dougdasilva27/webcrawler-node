...
public class BrasilNutriiCrawler extends CrawlerRankingKeywords{
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "http://www.nutrii.com.br/catalogsearch/result/index/?p=" + this.currentPage + "&q=" + this.keywordEncoded;
	...
	private String crawlProductUrl(Element e){
		...
		if(url != null) {
			...
			if(!productUrl.startsWith("http://www.nutrii.com.br/")) {
				productUrl = "http://www.nutrii.com.br/" + productUrl;
			}
		}
