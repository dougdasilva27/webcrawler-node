...
public class PeruWongCrawler extends CrawlerRankingKeywords {
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "https://www.wong.pe/busca/?ft=" + this.keywordEncoded + "&PageNumber=" + this.currentPage;
	    ...
	    if (!products.isEmpty()) {
	        ...
	        for (Element e : products) {
	          ...
	          this.log("Position: " + this.position + " - InternalId: " + internalId + " - InternalPid: " + productPid + " - Url: " + productUrl);
