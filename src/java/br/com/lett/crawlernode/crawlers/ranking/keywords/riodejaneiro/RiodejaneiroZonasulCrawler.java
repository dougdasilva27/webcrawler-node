...
public class RiodejaneiroZonasulCrawler extends VTEXGraphQLRanking {
   ...
   private String getCategoryId() {
      String url = "https://www.zonasul.com.br/" + this.location + "?__pickRuntime=appsEtag%2Cblocks%2CblocksTree%2Ccomponents%2CcontentMap%2Cextensions%2Cmessages%2Cpage%2Cpages%2Cquery%2CqueryData%2Croute%2CruntimeMeta%2Csettings";
      Request request = Request.RequestBuilder.create()
         .setUrl(url)
         .build();
      ...
      if (response.has("extensions") && !response.isNull("extensions")) {
         ...
         String categoryId = JSONUtils.getValueRecursive(extensions, "vtex.store@2.x:store.custom#" + this.location + "/search-result-layout.customQuery#coleção!content!querySchema!queryField", "!", String.class, null);
