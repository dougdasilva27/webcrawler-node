...
public class BrasilRihappyCrawler extends CrawlerRankingKeywords {
   ...
   private static final String KEY_SHA256 = "e1d5228ca8b18d1f83b777d849747a7f55c9597f670f20c8557d2b0428bf6be7";
   ...
   protected JSONObject fetchSearchApi() {
      ...
      url.append("https://www.rihappy.com.br/_v/segment/graphql/v1?");

      JSONObject extensions = new JSONObject();
      JSONObject persistedQuery = new JSONObject();

      persistedQuery.put("version", API_VERSION);
      persistedQuery.put("sha256Hash", KEY_SHA256);
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      if (products.length() > 0) {
         ...
         for (Object object : products) {
            ...
            String productUrl = "https://www.rihappy.com.br" + product.optString("link");
