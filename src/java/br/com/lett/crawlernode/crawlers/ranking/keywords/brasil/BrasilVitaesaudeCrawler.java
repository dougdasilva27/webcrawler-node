...
public class BrasilVitaesaudeCrawler extends CrawlerRankingKeywords{
	...
	protected void extractProductsFromCurrentPage() {
		...
		String url = "http://www.vitaesaude.com.br/search?search_query="+ this.keywordEncoded +"&section=product&page="+ this.currentPage +"&ajax=1";
	...
	protected boolean hasNextPage() {
		...
		if(lastPageElement != null) {
			...
			if(!text.isEmpty() && (this.currentPage < Integer.parseInt(text))) {
				return true;
			}
		}
	...
	private String crawlProductUrl(Element e){
		...
		if(url != null) {
			...
			if(!productUrl.startsWith("http://www.vitaesaude.com.br/")) {
				productUrl = "http://www.vitaesaude.com.br/" + productUrl;
			}
		}
