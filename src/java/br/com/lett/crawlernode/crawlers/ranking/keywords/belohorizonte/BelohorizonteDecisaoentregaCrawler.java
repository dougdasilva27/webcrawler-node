...
public class BelohorizonteDecisaoentregaCrawler extends CrawlerRankingKeywords {
   ...
   private void changeUrl() {
      ...
      apiUrl = "https://api.decisaoentrega.com.br/v1/loja/buscas/produtos/filial/1/centro_distribuicao/1/termo/" + this.keywordEncoded + "?page=" + this.currentPage;
   }

   private void getToken() {

      final String API_KEY = "df072f85df9bf7dd71b6811c34bdbaa4f219d98775b56cff9dfa5f8ca1bf8469";
      final String API_DOMAIN = "decisaoentrega.com.br";
      final String API_USERNAME = "loja";
      final String LOGIN_API = "https://api.decisaoentrega.com.br/v1/auth/loja/login";
   ...
   protected void extractProductsFromCurrentPage() {
      ...
      String url = "https://www.decisaoentrega.com.br/produtos/buscas?q=" + this.keywordEncoded + "?page=" + this.currentPage;
      changeUrl();
      ...
      if (produtosArray.length() >= 1) {
         ...
         for (Object e : produtosArray) {
            ...
            String urlHost = "decisaoentrega.com.br/produtos/detalhe/" + internalId;
