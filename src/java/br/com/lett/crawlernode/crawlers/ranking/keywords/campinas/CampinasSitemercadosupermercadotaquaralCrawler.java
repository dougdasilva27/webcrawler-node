 ...
 */
public class CampinasSitemercadosupermercadotaquaralCrawler extends BrasilSitemercadoCrawler {

   public CampinasSitemercadosupermercadotaquaralCrawler(Session session) {
      super(session);
   }
