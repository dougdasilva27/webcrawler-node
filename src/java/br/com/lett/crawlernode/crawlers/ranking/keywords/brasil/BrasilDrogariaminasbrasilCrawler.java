...
public class BrasilDrogariaminasbrasilCrawler extends CrawlerRankingKeywords {
  ...
  protected void extractProductsFromCurrentPage() {
    ...
    String url = "https://www.drogariaminasbrasil.com.br/catalogsearch/result/index/?itens=48&p=" + this.currentPage + "&q=" + this.keywordEncoded;
  ...
  private String crawlProductUrl(Element e) {
    ...
    if (url != null) {
      ...
      if (!productUrl.startsWith("http")) {
        productUrl = "https://www.drogariaminasbrasil.com.br/" + productUrl;
      }
    }
