...
public class BrasilStrarCrawler extends Crawler {
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         for (int i = 0; i < arraySkus.length(); i++) {
            ...
            String finalUrl = internalId != null && !internalId.isEmpty() ? CrawlerUtils.getRedirectedUrl(session.getOriginalURL(), session) : session.getOriginalURL();
   ...
   private RatingsReviews crawRating(String internalPid) {
      String storeKey = "4b536d74-d9b4-4d54-acdf-7693b516c572";
