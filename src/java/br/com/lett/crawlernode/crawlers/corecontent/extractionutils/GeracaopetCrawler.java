...
public class GeracaopetCrawler extends Crawler {
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         String secondaryImages = images.isEmpty() ? null : images.toString();
         ...
         children.forEach(obj -> {
            ...
            boolean available = skuJson.optBoolean("pickupAvailable", false);
            ...
            try {
               Offers offers = available ? scrapOffers(doc, skuJson, internalId) : new Offers();
