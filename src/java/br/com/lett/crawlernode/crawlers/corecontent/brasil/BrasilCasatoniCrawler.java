...
import br.com.lett.crawlernode.crawlers.corecontent.extractionutils.VtexRatingCrawler;
...
public class BrasilCasatoniCrawler extends Crawler {
   ...
   private static final String MAIN_SELLER_NAME_LOWER = "casatoni";
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         RatingsReviews ratingReviews = new VtexRatingCrawler(session, HOME_PAGE, logger, cookies)
               .extractRatingAndReviews(internalPid, doc, dataFetcher);
