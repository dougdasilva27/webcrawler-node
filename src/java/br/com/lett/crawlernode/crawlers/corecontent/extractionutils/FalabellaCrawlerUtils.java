...
public class FalabellaCrawlerUtils extends Crawler {
   ...
   private RatingsReviews crawlRating(String id) {
      ...
      AdvancedRatingReview reviewJson = scrapAdvancedRatingReview(reviewStatistics);
      ...
      ratingReviews.setAdvancedRatingReview(reviewJson);
   ...
   protected String crawlDescription(Document doc) {
      ...
      Elements descriptions = doc.select(".fb-product-information__specification__table tbody");
