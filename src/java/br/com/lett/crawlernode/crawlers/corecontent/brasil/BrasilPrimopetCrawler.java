...
public class BrasilPrimopetCrawler extends Crawler {
  
  public BrasilPrimopetCrawler(Session session) {
    super(session);
  }

  private static final String HOME_PAGE = "https://www.primopet.com.br/";
  private static final String MAIN_SELLER_NAME_LOWER = "primo pet";
