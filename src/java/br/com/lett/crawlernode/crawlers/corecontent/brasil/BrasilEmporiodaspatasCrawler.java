...
public class BrasilEmporiodaspatasCrawler extends Crawler {

  public BrasilEmporiodaspatasCrawler(Session session) {
    super(session);
  }

  private static final String HOME_PAGE = "https://www.emporiodaspatas.com.br/";
  private static final String MAIN_SELLER_NAME_LOWER = "empório das patas";
