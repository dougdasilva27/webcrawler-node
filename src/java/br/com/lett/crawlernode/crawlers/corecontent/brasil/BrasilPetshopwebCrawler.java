...
public class BrasilPetshopwebCrawler extends Crawler {
  ...
  public List<Product> extractInformation(Document doc) throws Exception {
    ...
    if (isProductPage(doc)) {
      ...
      String name = CrawlerUtils.scrapStringSimpleInfo(doc, "h1.produto-nome", true);
  ...
  private boolean isProductPage(Document doc) {
    return doc.selectFirst("h1.produto-nome") != null;
  }
