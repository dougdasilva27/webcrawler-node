...
public class BrasilAppRappiCrawler extends Crawler{
   ...
   private JSONObject fetchDocument() {
      ...
      String payload = "{\"context\":\"product_detail\",\"stores\":[900595776],\"offset\":0,\"limit\":5,\"state\":{\"store_type\":\"atacadao\",\"parent_store_type\":\"market\",\"product_id\":\"2141719064\",\"sessions\":\"0\",\"is_prime\":\"false\",\"zone_ids\":\"[]\",\"unlimited_shipping\":\"false\",\"lat\":\"-27.57929014867\",\"lng\":\"-48.588943853974\"},\"store_type\":\"atacadao\"}";
   ...
   private List<String> getSecondaryImages(JSONObject product){
      ...
      for (Integer i=0; i<JSONUtils.getJSONArrayValue(product, "images").length(); i++){
         secondaryImages.add(images.getString(i));
      }
   ...
   public List<Product> extractInformation(Document doc) throws MalformedProductException, OfferException, MalformedPricingException {
      ...
      if (json != null && !json.isEmpty()) {
         ...
         String primaryImage = JSONUtils.getStringValue(jsonProduct, "image");
