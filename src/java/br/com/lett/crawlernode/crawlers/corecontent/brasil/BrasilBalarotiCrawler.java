...
public class BrasilBalarotiCrawler extends Crawler {
  ...
  private static final String MAIN_SELLER_NAME_LOWER_2 =
      "balaroti comércio de materiais de construção sa";
  ...
  public List<Product> extractInformation(Document doc) throws Exception {
    ...
    if (isProductPage(doc)) {
      VTEXCrawlersUtils vtexUtil =
          new VTEXCrawlersUtils(session, MAIN_SELLER_NAME_LOWER_2, HOME_PAGE, cookies);
      ...
      for (int i = 0; i < arraySkus.length(); i++) {
        ...
        Marketplace marketplace = CrawlerUtils.assembleMarketplaceFromMap(marketplaceMap,
            Arrays.asList(MAIN_SELLER_NAME_LOWER, MAIN_SELLER_NAME_LOWER_2), session);
