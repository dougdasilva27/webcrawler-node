 ...
 */
public class MogidascruzesSitemercadosupermercadovcjjacomeCrawler extends BrasilSitemercadoCrawler {

   public MogidascruzesSitemercadosupermercadovcjjacomeCrawler(Session session) {
      super(session);
   }
   ...
   public static final int IDLOJA = 1711;
   public static final int IDREDE = 1507;
