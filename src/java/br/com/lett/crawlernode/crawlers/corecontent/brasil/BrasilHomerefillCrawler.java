 ...
 * 3 - In this market has no bank slip payment method
 * 4 - There is no secondary images in this market
 * 5 - There is no informations of installments 
 * 
...
public class BrasilHomerefillCrawler extends Crawler {
	...
	private String crawlInternalId(Document document) {
		...
		Element internalIdElement = document.select(".molecule-product-featured ").first();
