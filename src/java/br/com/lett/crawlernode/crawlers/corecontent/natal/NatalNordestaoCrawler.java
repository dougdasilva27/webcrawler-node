...
public class NatalNordestaoCrawler extends Crawler{

   private static final String SELLER_FULL_NAME = "Nordestão";
   private static final String CATEGORIES_API = "https://api.cliqueretire.nordestao.com.br/v1/loja/classificacoes_mercadologicas/departamentos/arvore/filial/1/centro_distribuicao/1";
   private String apiUrl = "https://api.cliqueretire.nordestao.com.br/v1/loja/produtos/";
   ...
   private void getToken(){
      ...
      final String API_DOMAIN = "cliqueretire.nordestao.com.br";
      final String API_USERNAME = "loja";
      final String LOGIN_API = "https://api.cliqueretire.nordestao.com.br/v1/auth/loja/login";
