...
public class BrasilMultisomCrawler extends Crawler {
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         RatingsReviews ratingReviews = crawRating(internalIDFirstProduct);
   ...
   private RatingsReviews crawRating(String internalIDFirstProduct) {
      YourreviewsRatingCrawler yourReviews = new YourreviewsRatingCrawler(session, cookies, logger, "e5006da2-cf44-417c-a86c-d99fbfc7fb23", this.dataFetcher);
      RatingsReviews ratingReviews = new RatingsReviews();
      ratingReviews.setDate(session.getDate());

      Document docRating = yourReviews.crawlPageRatingsFromYourViews(internalIDFirstProduct, "e5006da2-cf44-417c-a86c-d99fbfc7fb23", dataFetcher);
      ...
      AdvancedRatingReview advancedRatingReview = yourReviews.getTotalStarsFromEachValue(internalIDFirstProduct);
