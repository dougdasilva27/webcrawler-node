...
public class BrasilMaxAtacadistaCrawler  extends VTEXOldScraper {
   private static final String HOME_PAGE = "https://delivery.maxatacadista.com.br/";
   private static final List<String> MAIN_SELLER_NAME_LOWER = Arrays.asList("Max Atacadista Delivery ");
   ...
   private String sendRequestToAPI(String internalId, String type, String idWebsite) {
      ...
      Request request =
         Request.RequestBuilder.create().setUrl(apiUrl).setCookies(cookies).setHeaders(headers).setPayload(payload).mustSendContentEncoding(false).build();
