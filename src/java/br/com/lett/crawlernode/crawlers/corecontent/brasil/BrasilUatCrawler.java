 ...
 *
 */
public class BrasilUatCrawler extends Crawler {

  private static final String HOME_PAGE = "https://uat.parceiropg.com.br/b";

  public BrasilUatCrawler(Session session) {
    super(session);
  }
