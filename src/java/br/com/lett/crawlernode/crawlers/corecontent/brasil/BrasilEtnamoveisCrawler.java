 ...
 * 
 * 6) There is internalPid for skus in this ecommerce. The internalPid must be a number that is the
 * same for all the variations of a given sku.
 * 
 * 7) For this crawler, the page of sku is maked with (url + "?skuId=" + internalID), like this:
 * https://www.etna.com.br/etna/p/ar-condicionado-portatil-consul-12000-btus-127v/045303?skuId=0400295
 * 
 * 8) In page of sku, has links to variations of these.
 * 
 * 9) In voltage variations there is no internalPid, becuase the variations not appear in page of
 * sku.
 * 
 * 
 * Examples: ex1 (available): https://www.etna.com.br/etna/p/cabide-adulto-ker-acrilico/005225 ex2
 * (unavailable):
 * https://www.etna.com.br/etna/p/ar-condicionado-portatil-consul-12000-btus-127v/045303?skuId=0400295
 * 
