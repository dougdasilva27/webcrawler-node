...
public class BrasilTintasverginiaCrawler extends Crawler {
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         Float price = CrawlerUtils.scrapFloatPriceFromHtml(doc, ".compra-box .price-box .regular-price .price", null, false, ',', session);
   ...
   /**
    * Copy method from CrawlerUtils that checks the end on primaryImage url to verify if the secondary
    * image capure is not the same image as the primary with different path.
    * 
