...
public class FortalezaPaodeacucarCrawler extends Crawler {
  ...
  public List<Product> extractInformation(Document doc) throws Exception {
    ...
    return new GPACrawler(logger, session, HOME_PAGE, HOME_PAGE_HTTP, GPACrawler.FORTALEZA_STORE_ID, cookies, "pa", dataFetcher).extractInformation();
  }
}
