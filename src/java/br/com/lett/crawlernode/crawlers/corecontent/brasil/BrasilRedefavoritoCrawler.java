...
public class BrasilRedefavoritoCrawler extends Crawler {
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.favoritosupermercados.com.br/v1/loja/produtos/" + internalIdFromURL + "/filial/1/centro_distribuicao/1/detalhes";
