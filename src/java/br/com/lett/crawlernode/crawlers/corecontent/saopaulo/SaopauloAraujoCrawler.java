...
public class SaopauloAraujoCrawler extends Crawler {
  ...
  private static final String MAIN_SELLER_NAME_LOWER = "araujo";
  ...
  private boolean isProductPage(Document document) {
    return document.select(".product-name").first() != null;
  }
  ...
  private Prices crawlPrices(String internalId, Float price, JSONObject jsonSku) {
    ...
    if (price != null) {
      String url = "https://www.araujo.com.br/productotherpaymentsystems/" + internalId;
      Document doc =
  ...
  private JSONObject crawlApi(String internalId) {
    String url = "https://www.araujo.com.br/produto/sku/" + internalId;
