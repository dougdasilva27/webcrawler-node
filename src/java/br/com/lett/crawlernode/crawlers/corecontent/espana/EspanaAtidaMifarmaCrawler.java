...
public class EspanaAtidaMifarmaCrawler extends Crawler {

   private static final String SELLER_FULL_NAME = "Atida Mifarma";
...
//      headers.put("Cookie", "PHPSESSID=" + this.cookiePHPSESSID + ";");
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         String name = CrawlerUtils.scrapStringSimpleInfo(doc, "main h1", true);
         String primaryImage = null;
         String description = null;
         boolean availableToBuy = !doc.select("[data-testid='pricePrice']").isEmpty(); //not find unavailable
   ...
   private boolean isProductPage(Document doc) {
      return doc.selectFirst("[data-testid='product-image-slide']") != null;
   }
   ...
   private Pricing scrapPricing(Document doc) throws MalformedPricingException {
      Double spotlightPrice = CrawlerUtils.scrapDoublePriceFromHtml(doc, "[data-testid='pricePrice']", null, false, ',', session);
      Double priceFrom = CrawlerUtils.scrapDoublePriceFromHtml(doc, "[data-testid='priceRRP'] ", null, false, ',', session);
