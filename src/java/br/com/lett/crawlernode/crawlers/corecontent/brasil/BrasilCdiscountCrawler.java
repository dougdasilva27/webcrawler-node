...
public class BrasilCdiscountCrawler extends Crawler {
	...
	/**
	 * Looks if the sku selector option contains valid sku data.
	 * In some cases the selector doesn't display the sku info, but
	 * rather information about the selector itself.
	 * 
	 * e.g:
	 ...
	 * 
	 * e.g:
	 * <option value="24084">110V |  R$ 355,60</option>
	 * 
	 * @param skuOption
	 * @return
	 */
	...
	/**
	 * Looks if the id is on the current option.
	 * Used when we are iterating through all sku options on the page, and
	 * want to avoid crawl skus that we already crawled.
	 * 
	 * @param id
	 * @param skuOption
	 * @return
	 ...
	 * rel=
	 * {
	 * gallery: 'produtoPrincipal', 
	 * smallimage: 'http://www.cdiscount-imagens.com.br/Eletroportateis/Cafeteiras/CafeteirasEletricas/24084/3235554/Cafeteira-Eletrica-Philips-Walita-RI7546-c-Jarra-em-Inox-24084.jpg',
	 * largeimage: '#'
	 * }
	 * @param imageSize
	 * @param relAttribute
