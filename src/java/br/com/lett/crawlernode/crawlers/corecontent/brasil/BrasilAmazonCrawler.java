...
public class BrasilAmazonCrawler extends Crawler {
   ...
   private Pricing scrapMainPagePricing(Element doc) throws MalformedPricingException {
      ...
      Double priceFrom = savings != null ? spotlightPrice + savings : CrawlerUtils.scrapDoublePriceFromHtml(doc, "#buyBoxInner .a-list-item span:nth-child(2n)", null, false, ',', session);
