 ...
 *
 */
public class BelohorizonteCarrefourCrawler extends BrasilCarrefourCrawler {
   ...
   protected String fetchPage(String url) {
      ...
      headers.put("cookie", "statusCepConsultation=true; cepConsultation=31310-250; sideStoreOn=true; "
            + "selectedPointOfServices=BRA041%2CBRA041;");
