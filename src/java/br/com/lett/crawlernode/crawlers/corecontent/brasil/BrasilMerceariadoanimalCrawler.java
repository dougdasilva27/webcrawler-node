      ...
      if (isProductPage(doc)) {
         ...
         if (!allVariations.isEmpty()) {
            for (Element variation : allVariations) {
               ...
               String variationSize = variation.parent().text();
               ...
               Offers variationOffers = json.getBoolean("instock") ? scrapVariationOffers(json) : null;
               clone.setName(product.getName() + " " + variationSize.replace("(Indisponível)", "").trim());
