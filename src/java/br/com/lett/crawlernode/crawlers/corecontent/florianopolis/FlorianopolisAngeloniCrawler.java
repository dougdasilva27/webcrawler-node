...
public class FlorianopolisAngeloniCrawler extends Crawler {
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         String primaryImage = CrawlerUtils.scrapSimplePrimaryImage(doc, ".container__body-detalhe-produto .p-relative img", Arrays.asList("data-zoom-image", "src"), "https", host);
