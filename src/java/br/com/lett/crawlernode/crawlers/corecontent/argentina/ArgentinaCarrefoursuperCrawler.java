 ...
 *
 */
public class ArgentinaCarrefoursuperCrawler extends Crawler {
  ...
  public List<Product> extractInformation(Document doc) throws Exception {
    ...
    if (isProductPage(doc)) {
      ...
      String description = CrawlerUtils.scrapSimpleDescription(doc, Arrays.asList(".especificaciones-content"));
  ...
  private Prices crawlPrices(Element doc) {
    ...
    Float price = CrawlerUtils.scrapFloatPriceFromHtml(doc, ".product-shop .precio-regular-productos-destacados, .product-shop .regular-price", null,
        true, ',', session);
