...
public class BrasilKitchenaidCrawler extends Crawler {
  ...
  private String crawlDescription(Document doc) {
    ...
    Element shortDescription = doc.select(".js-product-infos").first();
  ...
  private Prices crawlPrices(String internalId, Float price, JSONObject jsonSku, Document docHome) {
    ...
    if (price != null) {
      String url = "http://www.kitchenaid.com.br/productotherpaymentsystems/" + internalId;
  ...
  private JSONObject crawlApi(String internalId) {
    String url = "http://www.kitchenaid.com.br/produto/sku/" + internalId;
