...
public class BrasilRossisupermercadosCrawler extends Crawler {
   ...
   public JSONObject crawlApi(String token) {
      ...
      String url = "https://api.rossidelivery.com.br/v1/loja/produtos/" + internalIdFromURL + "/filial/1/centro_distribuicao/1/detalhes";
