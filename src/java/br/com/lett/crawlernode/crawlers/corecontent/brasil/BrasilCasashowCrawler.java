 ...
 * http://www.casashow.com.br/cafeteira-eletrica-arno-cafp---preta-1000008369/p ex2 (unavailable):
 * http://www.casashow.com.br/ar-condicionado-janela-7500btus-duo-mecanico-frio-127v-branco-qca078bbb-springer/p
 *
...
public class BrasilCasashowCrawler extends Crawler {
  ...
  private String crawlDescription(Document document) {
    ...
    if (specificationElement != null)
      description = description + specificationElement.html();
