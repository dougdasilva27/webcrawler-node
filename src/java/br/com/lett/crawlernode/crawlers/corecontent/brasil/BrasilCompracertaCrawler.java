...
public class BrasilCompracertaCrawler extends Crawler {
  ...
  private boolean isProductPage(Document document) {
    return document.select(".main-product").first() != null;
  }
  ...
  private Prices crawlPrices(String internalId, Float price, JSONObject jsonSku) {
    ...
    if (price != null) {
      String url = "http://loja.compracerta.com.br/productotherpaymentsystems/" + internalId;
  ...
  private JSONObject crawlApi(String internalId) {
    String url = "http://loja.compracerta.com.br/produto/sku/" + internalId;
