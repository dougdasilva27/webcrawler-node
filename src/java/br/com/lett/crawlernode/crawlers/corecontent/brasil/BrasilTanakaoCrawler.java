   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         CategoryCollection categories =
               CrawlerUtils.crawlCategories(doc, ".breadcrumbs > ul > li", true);
         String primaryImage =
               CrawlerUtils.scrapSimplePrimaryImage(
                     doc, "a.rsImg", Arrays.asList("data-rsbigimg", "href"), "https", HOME_PAGE);
         String secondaryImages = CrawlerUtils.scrapSimpleSecondaryImages(doc, "#galeria a", Collections.singletonList("href"), "https", HOME_PAGE, primaryImage);
         String description =
