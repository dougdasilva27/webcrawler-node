...
class ArgentinaLagallegaCrawler(session: Session) : Crawler(session) {
   ...
   companion object {
      const val SELLER_NAME: String = "La Gallega"

      fun getCookies(dataFetcher: DataFetcher, session: Session): List<Cookie> {
         val url = "https://www.lagallega.com.ar/index.asp"
   ...
   override fun fetch(): Document {
      ...
      val url = "https://www.lagallega.com.ar/Detalle.asp?Pr=${internalId}&P="
   ...
   override fun extractInformation(doc: Document): MutableList<Product> {
      ...
      if (primaryImage != null) {
         primaryImage = "https://www.lagallega.com.ar/${primaryImage}"
      }
