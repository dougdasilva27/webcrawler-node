...
public class ArgentinaMaxidescuentoCrawler extends Crawler {

   private static final String SELLER_FULL_NAME = "Maxi Descuento";
   ...
   public List<Product> extractInformation(Document doc) throws Exception {
      ...
      if (isProductPage(doc)) {
         ...
         // When this Crawler was made, there was no secondary image on the site.
   ...
   private boolean isProductPage(Document doc) {
      return doc.selectFirst("#content-wrapper") != null;
   }
   ...
   private List<String> scrapSales(Document doc) {
      ...
      Element salesOneElement = doc.selectFirst(".product-prices .current-price .discount.discount-percentage");
   ...
   private Pricing scrapPricing(Document doc) throws MalformedPricingException {
      Double spotlightPrice = CrawlerUtils.scrapDoublePriceFromHtml(doc, ".product-prices .current-price span[itemprop=\"price\"]", null, false, ',', session);
      Double priceFrom = CrawlerUtils.scrapDoublePriceFromHtml(doc, ".product-prices .regular-price", null, false, ',' , session);
