 ...
 * 
 * 10) The secondary images for colors are get in api "http://www.polishop.com.br/produto/sku/" +
 * internalId
 * 
 * 11) To get normal images, is get images that has element "-main-", primary images ends with
 * "01.jpg".
 * 
 * 12) has "tm"² in names.
 * 
 ...
 * http://www.polishop.com.br/fritadeira-airfryer-avance-xl-philips-walita/p ex2 (unavailable):
 * http://www.polishop.com.br/ar-condicionado-pinguino-maxxi-cooling-exclusive-delonghi/p ex3 (with
 * colors): http://www.polishop.com.br/batom-hidratante-fps-20-be-emotion/p ex4 (with colors and
 * size): http://www.polishop.com.br/calca-capri-craveworthy-legging/p ex5 (sepcial product):
 * http://www.polishop.com.br/nutri-ninja-auto-iq/p
 *
 *
 ************************************************************************************************************************************************************************************/
