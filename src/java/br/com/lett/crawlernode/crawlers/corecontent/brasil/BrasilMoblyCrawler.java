...
import br.com.lett.crawlernode.crawlers.corecontent.extractionutils.YotpoRatingReviewCrawler;
...
public class BrasilMoblyCrawler extends Crawler {
   ...
   private Prices crawlPrices(JSONObject jsonPrices) {
      ...
      Float price = JSONUtils.getFloatValueFromJSON(jsonPrices, "finalPrice", false);
      if (price != null) {
