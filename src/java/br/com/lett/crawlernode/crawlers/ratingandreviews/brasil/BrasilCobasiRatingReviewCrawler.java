...
public class BrasilCobasiRatingReviewCrawler extends RatingReviewCrawler {
  ...
  /**
   * Page Ratings Url: http://www.cobasi.com.br/userreview Ex payload:
  ...
  private Document crawlPageRatings(String url, String internalPid) {
    ...
    Request request =
        RequestBuilder.create().setUrl("https://www.cobasi.com.br/userreview").setCookies(cookies).setHeaders(headers).setPayload(payload).build();
