...
//			Double avgRating = getTotalAvgRating(ratings, totalNumOfEvaluations);
	...
	/**
	 * Para esse market foi necessario fazer uma engenharia reversa 
	 * para conseguir capturar 2 parametros da url de rating que sao baseados no
	 * considerado "internalPid" do produto, com isso ao realizar essa engenharia
	 * foi notado que no arquivo full.js tem uma função que monta esses parâmetros
	 * baseados em uma string, no caso o internalPid. Essa função em js
	 * foi traduzida para java para podermos montar a url de rating dos produtos.
	 * 
	 * Abaixo segue a função traduzida para java, que tem o objetivo de retornar 
	 * 5 caracteres sendo eles ++/++ onde o + seriam números, esses números são retirados
	 * de um charcode do internalPid, depois pega o módulo de 255 - o charcode de um caracter do mesmo
	 * e tudo isso sendo somado em uma variavel DA. Após isso é pego o resto da divisão
	 * desse DA por 1023 e transformado em string. Caso esse resto não dê 4 carcateres, é importante
	 * que coloque 0's no inicio da string até completar os 4 caracteres. Depois damos um split na metade
	 * dessa string e colocamos uma barra no meio e assim teremos os 2 parâmetros para a url de rating.
	 *  
	 ...
	 * [{r:{id:220121082,si:2,pi:27515520,dp:true,mu:13070544,v:0,t:0,r:5,h:"A fralda &eacute; &oacute;tima para sair, n&atilde;o vaza, grandinha atr&aacute;s",
	 * n:"DIDI",l:"pt_BR", w:"Campos dos Goytacazes\/RJ",fc:0,b:{n:"Avalia&ccedil;&atilde;o Geral",k:"Yes"},
	...
	private JSONArray crawlScriptWithReviews(String internalPid) {
		...
		String url = "http://www.extra-imagens.com.br/Js/pwr/content/"+ parametersBasedOnInternalPid +"/"+ internalPid +"_2-pt_BR-1-reviews.js";
