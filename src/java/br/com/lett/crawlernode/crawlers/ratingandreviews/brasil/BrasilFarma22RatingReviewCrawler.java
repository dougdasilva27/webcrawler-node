...
public class BrasilFarma22RatingReviewCrawler extends RatingReviewCrawler {
  ...
  private Document crawlPageRatings(String internalPid) {
    ...
    String url = "http://service.yourviews.com.br/review/GetReview?storeKey=d8f4f406-5164-4042-81aa-a7fe0ec787f0" + "&productStoreId=" + internalPid
        + "&extendedField=&callback=_jqjsp&_1504115699466=";

    Request request = RequestBuilder.create().setUrl(url).setCookies(cookies).build();
    String code = this.dataFetcher.get(session, request).getBody();
