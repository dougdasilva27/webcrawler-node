...
public class BrasilShopfatoRatingReviewCrawler extends RatingReviewCrawler {
	...
	/**
	 * Api Ratings
	 * Url: http://www.shopfato.com.br/userreview
	...
	private Document crawlPageRatings(String url, String internalPid){
		...
		String response = POSTFetcher.fetchPagePOSTWithHeaders("http://www.shopfato.com.br/userreview", session, payload, cookies, 1, headers);
