package br.com.lett.crawlernode.crawlers.ratingandreviews.saopauloavmorumbi;
 ...
 *
 */
public class SaopauloavmorumbiTendadriveRatingReviewCrawler extends RatingReviewCrawler {

  public SaopauloavmorumbiTendadriveRatingReviewCrawler(Session session) {
    super(session);
  }
  ...
  private boolean isProductPage(Document doc) {
    return !doc.select(".produto").isEmpty();
  }
  ...
  private JSONObject requestTrustVoxEndpoint(int id, Document doc) {
    ...
    requestURL.append("&");
    requestURL.append("store_id=80984");
