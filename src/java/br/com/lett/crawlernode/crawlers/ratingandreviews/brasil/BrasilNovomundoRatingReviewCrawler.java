...
public class BrasilNovomundoRatingReviewCrawler extends RatingReviewCrawler {
	...
	/**
	 * Api Ratings
	 * Url: https://www.novomundo.com.br/userreview
	...
	private Document crawlPageRatings(String url, String internalPid){
		...
		String response = POSTFetcher.fetchPagePOSTWithHeaders("https://www.novomundo.com.br/userreview", session, payload, cookies, 1, headers);
	...
	private boolean isProductPage(Document document) {
		return document.select(".line.product-info").first() != null;
	}
}
