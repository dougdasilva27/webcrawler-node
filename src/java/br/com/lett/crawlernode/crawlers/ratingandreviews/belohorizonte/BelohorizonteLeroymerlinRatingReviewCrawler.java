...
public class BelohorizonteLeroymerlinRatingReviewCrawler extends LeroymerlinRatingReviewCrawler {

  public BelohorizonteLeroymerlinRatingReviewCrawler(Session session) {
    super(session);
  }
