...
public class SaopauloDrogariasaopauloRatingReviewCrawler extends RatingReviewCrawler {
	...
	/**
	 * Page Ratings Url: http://www.drogariasaopaulo.com.br/userreview Ex payload:
	 * productId=542865&productLinkId=fralda-descartavel-pampers-premium-care-xxg-32-unidades Ex:
	...
	private Document crawlPageRatings(String url, String internalPid) {
		...
		String response = POSTFetcher.fetchPagePOSTWithHeaders(
				"https://www.drogariasaopaulo.com.br/userreview", session, payload, cookies, 1, headers);
