...
public class BrasilBalaodainformaticaRatingReviewCrawler extends RatingReviewCrawler {
   ...
   * productId=542865&productLinkId=iphone-7-32gb-preto-matte-ref107958 Required headers to crawl this
   * api Ex: Média de avaliações: 5 votos
   *
  ...
  private Document crawlPageRatings(String url, String internalPid) {
    ...
    // Parameter in url for request POST ex: "iphone-7-32gb-preto-matte-ref107958" IN URL
    // "http://www.balaodainformatica.com.br/iphone-7-32gb-preto-matte-ref107958/p"
    ...
    Request request = RequestBuilder.create().setUrl("http://www.balaodainformatica.com.br/userreview").setCookies(cookies).setHeaders(headers)
