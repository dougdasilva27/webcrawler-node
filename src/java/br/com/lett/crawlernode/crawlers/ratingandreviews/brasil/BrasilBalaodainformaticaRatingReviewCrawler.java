...
public class BrasilBalaodainformaticaRatingReviewCrawler extends RatingReviewCrawler {
	 ...
	 * productId=542865&productLinkId=iphone-7-32gb-preto-matte-ref107958 Required headers to crawl
	 * this api Ex: Média de avaliações: 5 votos
	 *
	...
	private Document crawlPageRatings(String url, String internalPid) {
		...
		String response = POSTFetcher.fetchPagePOSTWithHeaders(
				"http://www.balaodainformatica.com.br/userreview", session, payload, cookies, 1, headers);
