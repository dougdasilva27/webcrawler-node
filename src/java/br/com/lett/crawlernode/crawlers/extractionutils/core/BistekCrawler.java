...
public abstract class BistekCrawler extends Crawler {

   private final String HOST = getLocation() + ".bistek.com.br";
   ...
   public boolean shouldVisit() {
      ...
      return !FILTERS.matcher(href).matches() && href.startsWith(getLocation());
   }
