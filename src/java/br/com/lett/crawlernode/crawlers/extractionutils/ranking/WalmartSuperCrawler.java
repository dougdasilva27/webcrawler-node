...
public class WalmartSuperCrawler extends CrawlerRankingKeywords {
   ...
   protected void processBeforeFetch() {
      ...
      headers.put(com.google.common.net.HttpHeaders.ORIGIN, HOME_PAGE);
      headers.put(com.google.common.net.HttpHeaders.REFERER, HOME_PAGE);
      headers.put(HttpHeaders.CONTENT_TYPE, "application/json");
      headers.put("authority", "super.walmart.com.mx");
      headers.put("x-o-bu", "WALMART-MX");
      headers.put("x-o-ccm", "server");
      headers.put("x-o-gql-query", "mutation setPickup");
      headers.put("x-o-mart", "B2C");
      headers.put("x-o-platform", "rweb");
      headers.put("x-o-platform-version", "main-1.26.1-90b166");
