...
public class QueueService {
   ...
   static {
      ...
      queueURLMap.put(QueueName.WEB_SCRAPER_MIRANHA_SEED.toString(), QUEUE_URL + QueueName.WEB_SCRAPER_MIRANHA_SEED.toString());
      queueURLMap.put(QueueName.WEB_SCRAPER_DISCOVERER_MIRANHA_CAPTURE.toString(), QUEUE_URL + QueueName.WEB_SCRAPER_DISCOVERER_MIRANHA_CAPTURE.toString());
