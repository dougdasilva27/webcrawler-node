...
public class DataCipher {
	...
	public String fetchRemoteKey(String url) {
		...
		try {
			...
			System.err.println("Erro ao pegar chave da Amazon");
			e.printStackTrace();
		}
	...
	public String encryptData(String userPassword, String data)
	...
	public String decryptData(String userPassword, String encryptedData) 
			throws IOException {
