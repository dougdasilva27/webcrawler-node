...
public class ProcessedModel {
	...
	public ProcessedModel clone () {
		return new ProcessedModel(
				this.id, this.internalId, this.internalPid, this.originalName, this._class, this.brand, this.recipient, this.quantity, this.multiplier,
				this.unit, this.extra, this.pic, this.secondary_pics, this.cat1, this.cat2, this.cat3, this.url, this.market, this.ect, this.lmt, this.lat, 
				this.lrt, 
				this.lms, 
				this.status, 
